...
For those unfamiliar, [GitHub](https://github.com) is the version control platform I use to store almost all of the code I write. One fun (and slightly addictive) feature is that it keeps track of the number of “contributions” you, well, contribute each day. Many things [count as a contribution](https://docs.github.com/en/account-and-profile/reference/profile-contributions-reference), but it’s essentially any addition, change, or improvement made to a code base. On your profile, this shows up as a calendar heat map—a 7-row, 52-column table of squares, each representing one day of the year and shaded green based on how much you contributed that day.
...
Below is a breakdown of my contributions by month. March is classically known as “hell month” thanks to mid-semester chaos, while June and September were noticeably calmer with the peak of summer and the start of a new school year.
![Dan's GitHub Contributions by Month 2025](/blog/github-wrapped-2025/github_contr_by_month_2025.png "Dan's GitHub Contributions by Month 2025")
