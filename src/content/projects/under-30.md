...
description: "A Visual Studio Code extension that promotes good coding standards by displaying real-time line selection counts and detecting functions that exceed customizable length thresholds. Used by 900+ users."
